<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="RequerimientosZona.aspx.cs" Inherits="PodaProject.App.Division.RequerimientosZona" %>
...
<asp:Content ContentPlaceHolderID="cabecera" runat="server">
    Requerimientos de zona
</asp:Content>

<asp:Content ContentPlaceHolderID="descripcion" runat="server">
    Requerimientos de necesidades de brecha y poda
</asp:Content>
            ...
            <form role="form" runat="server">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" value="<%= Zona.Nombre %>" disabled="disabled" />
                    </div>
                </div>
                <div class="form-group">
                    <label>Presupuesto asignado a zona</label>
                    <div class="input-group">
        ...
        <div class="box-body">
            <div class="table-responsive">
                <table id="necesidades" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <asp:Literal ID="litTablaAreas" runat="server"></asp:Literal>
                    </tbody>
                </table>
            </div>
        </div>
