...
{
    public partial class SeleccionReporteDeEjecucionZona : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    p.Rellenar();
                    string url = ResolveUrl("~/App/Division/SeleccionReporteDeEjecucionArea.aspx?id=" + p.Clave);
