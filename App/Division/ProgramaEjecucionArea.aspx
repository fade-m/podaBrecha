<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ProgramaEjecucionArea.aspx.cs" Inherits="PodaProject.App.Division.ProgramaEjecucionArea" %>
...
<asp:Content ContentPlaceHolderID="descripcion" runat="server">
        Visualizar los programas de ejecucion del area seleciconada con respecto a la necesidad seleccionada.
</asp:Content>
        ...
        <div class="box box-pane">
         <div class="box-body">
                    <div class="table-responsive">
                        ...
                        <table id="necesidades" class="table table-bordered table-hover table-responsive">
                            <thead>
                                <tr>
