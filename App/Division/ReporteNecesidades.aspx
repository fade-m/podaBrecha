<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ReporteNecesidades.aspx.cs"
    Inherits="PodaProject.App.Division.ReporteNecesidades" CodeFile="~/App/Division/ReporteNecesidades.aspx.cs" %>
            ...
            <div class="box box-danger">
                ...
                <div class="box-body">
                    <form role="form">
                        ...
                        <div class="form-group">
                            <label>Recurso divisional</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-dollar"></i></span>
                                <input type="text" id="presupuesto" class="form-control" value="<%= RecursoDivisional.Monto %>" disabled="disabled" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Necesidad total de las zonas</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-dollar"></i></span>
