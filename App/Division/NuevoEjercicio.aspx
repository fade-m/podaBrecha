<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="NuevoEjercicio.aspx.cs" 
    CodeFile="~/App/Division/NuevoEjercicio.aspx.cs" Inherits="PodaProject.App.Division.NuevoEjercicio" %>
...
<asp:Content ID="descripcion" ContentPlaceHolderID="descripcion" runat="server">
    Dar de alta un nuevo ejercicio de necesidades
</asp:Content>
